...
// Unlike the Anchor example, the Pinocchio program receives the PDA bumps in the
// instruction data (and stores them) instead of deriving them on-chain.
...
export function buildCheckContributions(props: {
  ...
  const data = borshSerialize(NoArgsSchema, {
