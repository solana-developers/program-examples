                ...
                <tr key={wallet.address || String(index)}>
                  ...
                  <td>
                    <select
                      ...
                      value={wallet.mode}
                      onChange={(e) =>
                        handleUpdateWallet(index, "mode", e.target.value as "allow" | "block" | "remove")
                      }
                      disabled={isProcessing}
                    >
                      <option value="allow">Allow</option>
                      <option value="block">Block</option>
                      {existingWallets.has(wallet.address) && <option value="remove">Remove</option>}
                    </select>
                  </td>
                  <td>
                  ...
                  <td>
                    <Button onClick={() => handleRemoveWallet(index)} disabled={isProcessing} variant="ghost">
                      Remove
                    </Button>
                  </td>
                </tr>
