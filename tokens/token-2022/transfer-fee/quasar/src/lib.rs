...
impl Initialize<'_> {
    #[inline(always)]
    pub fn initialize(&self, basis_points: u16, max_fee: u64) -> Result<(), ProgramError> {
        ...
        ext_data[33..65].copy_from_slice(self.payer.to_account_view().address().as_ref());
...
impl UpdateFee<'_> {
    #[inline(always)]
    pub fn update_fee(&self, basis_points: u16, max_fee: u64) -> Result<(), ProgramError> {
