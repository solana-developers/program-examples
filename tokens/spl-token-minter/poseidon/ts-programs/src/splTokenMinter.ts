import { AssociatedTokenAccount, Mint, Pubkey, type Result, Signer, TokenProgram, UncheckedAccount, u8, u64 } from '@solanaturbine/poseidon';
...
export default class SplTokenMinter {
  static PROGRAM_ID = new Pubkey('BkKrNLYEGtdwZtpywocGuKXPHCxDaRzQBkdevfAaQ2Rh');
